...
int main() {
    ...
    Leader leader1("Pierre", "Argenta", "Roche", racaillou, onix, gravalanch, grolem, rhinocorne, rhinoféros, "Bravo tu m'as battu! Comme-ci je mettais reçu une pierre sur la tête.");
    ...
    while (continuer) {
        ...
        switch (choix) {
            ...
            case 7:
                ...
                break;
            case 8: {
                cout << "Avec quel leader voulez-vous interagir ? (1: Pierre(Roche), 2: Ondine(Cascade), 3: Major Bob(Foudre), 4: Erika(Prisme)) : ";
